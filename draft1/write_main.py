#!/usr/bin/env python3
"""Writes the full IEEE LaTeX paper to main.tex"""
...
print(f"Total characters: {len(latex_content)}")
print(f"Total lines: {latex_content.count(chr(10))}")
